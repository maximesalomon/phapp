  ...
  return (
    <div>
      ...
      <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
          <a href="https://api.producthunt.com/v2/oauth/authorize?client_id=e14e77d9332895fbb8136b11380eb397f4d7275a39c5e7b3b9b06c2a11eedccc&redirect_uri=https://croissant.io&response_type=code&scope=public+private" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-orange-600 hover:bg-white mt-4 lg:mt-0">Login</a>
        </div>
      </div>
    </nav>
